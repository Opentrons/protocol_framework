...
@pytest.mark.parametrize("defname", list_deck_definition_names(version=6))
def test_v6_defs(defname: str) -> None:
    defn = load_deck_definition(name=defname, version=6)
    typeguard.check_type(defn, DeckDefinitionV6)

...
export const FLEX_STACKER_A4_ADDRESSABLE_AREA: 'flexStackerV1A4' =
  'flexStackerV1A4'
export const FLEX_STACKER_B4_ADDRESSABLE_AREA: 'flexStackerV1B4' =
  'flexStackerV1B4'
export const FLEX_STACKER_C4_ADDRESSABLE_AREA: 'flexStackerV1C4' =
  'flexStackerV1C4'
export const FLEX_STACKER_D4_ADDRESSABLE_AREA: 'flexStackerV1D4' =
  'flexStackerV1D4'

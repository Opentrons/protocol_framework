...
# these will probably never change, determined by plate-reader
...
def add_parameters(params: ParameterContext) -> None:
    ...
    params.add_int("diluent_dead_vol", "diluent_dead_vol", default=3, unit="mL")
    params.add_int(
...
def spread_red_dye(
    ...
    source_plate.load_liquid([p.src_well], p.starting_volume, red_dye)

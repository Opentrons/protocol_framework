...
metadata = {
    "protocolName": "96 channel with plate reader",
    "author": "Josh McVey",
    "description": "A protocol to demonstrate the use of a 96 channel pipette with a plate reader",
}
...
well_plate_choices = [
    {"display_name": "Nest 100ul pcr full skirt", "value": "nest_96_wellplate_100ul_pcr_full_skirt"},
    {"display_name": "Opentrons 200ul pcr full skirt", "value": "opentrons_96_wellplate_200ul_pcr_full_skirt"},
]
...
def add_parameters(parameters):
    ...
    parameters.add_str(
        display_name="Well Plate",
        variable_name="well_plate_load_name",
        choices=well_plate_choices,
        default="opentrons_96_wellplate_200ul_pcr_full_skirt",
        description="Select the well plate type",
    )
...
def run(ctx):
    ...
    well_load_name = ctx.params.well_plate_load_name
    well_position = ctx.params.well_plate_position
    ...
    well = ctx.load_labware(well_load_name, well_position)
    ...
    # TODO multiMeasure with a single wavelength
    # TODO singleMeasure with multiple wavelengths
    # TODO 